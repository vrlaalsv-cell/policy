...
- 🔴 **왜 자동화했나** — 행안부는 오래된 첨부를 **순차적으로 내린다.** 실측(2026-08-12): 3일 전만 해도
  받아지던 2026-01-23~02-03 4건이 그 사이 전부 HTTP 400 이 됐다. **제때 안 받으면 영구 소실**이고
  다시 받을 방법이 없다. 사람이 기억해서 돌리는 구조로는 반드시 놓친다.
